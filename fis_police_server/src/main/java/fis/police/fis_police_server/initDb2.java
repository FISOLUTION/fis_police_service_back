    ...
    static class InitService {
        ...
        public void dbInit() {
            ...
            Schedule schedule1 = Schedule.createSchedule(center1, user1, agent1, LocalDate.now(),
                    LocalDate.parse("2022-03-01"),LocalTime.parse("09:00:00"), 500, "특이사항 없음", "특이사항 없음", Accept.accept,null);
            em.persist(schedule1);
            Schedule schedule2 = Schedule.createSchedule(center1, user2, agent1, LocalDate.now(),
                    LocalDate.parse("2022-03-02"),LocalTime.parse("10:00:00"), 500, "특이사항 없음", "특이사항 없음",Accept.accept,"차가 막혀요");
