...
public class AppScheduleResponse {
    ...
    @QueryProjection
    public AppScheduleResponse(Long schedule_id, LocalDate visit_date, LocalTime visit_time, Integer estimate_num, String center_etc, String agent_etc, String total_etc, Long center_id, String c_name, String c_address, String c_zipcode, String c_ph, Complete complete) {
