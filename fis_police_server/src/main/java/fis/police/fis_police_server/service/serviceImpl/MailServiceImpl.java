...
//        mimeMessageHelper.addAttachment("21년 지문등 사전등록 신청서_양식.hwp", fsr3)
        ...
        switch (sido) {
            ...
            case "부산광역시":
                ...
                break;
            case "경상북도":
                file2 += "/22_request_for_cooperation_gyeongbuk.pdf";
                fileName = "22년_협조요청_공문_경북.pdf";
                addAttachFile(file2, mimeMessageHelper, fileName);
                break;
            case "광주광역시":
                file2 += "/22_request_for_cooperation_gwangju.pdf";
                fileName = "22년_협조요청_공문_광주.pdf";
                addAttachFile(file2, mimeMessageHelper, fileName);
                break;
            case "울산광역시":
                file2 += "/22_request_for_cooperation_ulsan.pdf";
                fileName = "22년_협조요청_공문_울산.pdf";
                addAttachFile(file2, mimeMessageHelper, fileName);
                break;
            case "세종특별자치시":
                file2 += "/22_request_for_cooperation_sejong.pdf";
                fileName = "22년_협조요청_공문_세종.pdf";
                addAttachFile(file2, mimeMessageHelper, fileName);
                break;
            case "제주특별자치도":
                file2 += "/22_request_for_cooperation_jeju.pdf";
            ...
            case "전라남도":
                ...
                break;
            case "충청북도":
                file2 += "/22_request_for_cooperation_chungbuk.hwp";
                fileName = "22년_협조요청_공문_충북.hwp";
                addAttachFile(file2, mimeMessageHelper, fileName);
                break;
            case "충청남도":
                file2 += "/22_request_for_cooperation_chungnam.hwp";
                fileName = "22년_협조요청_공문_충남.hwp";
                addAttachFile(file2, mimeMessageHelper, fileName);
                break;
            case "대전광역시":
                file2 += "/22_request_for_cooperation_daejeon.hwp";
                fileName = "22년_협조요청_공문_대전.hwp";
                addAttachFile(file2, mimeMessageHelper, fileName);
                break;
            case "대구광역시":
                file2 += "/22_request_for_cooperation_daegu.hwp";
                fileName = "22년_협조요청_공문_대구.hwp";
                addAttachFile(file2, mimeMessageHelper, fileName);
                break;
            case "강원도":
                file2 += "/22_request_for_cooperation_gangwon.hwp";
                fileName = "22년_협조요청_공문_강원.hwp";
                addAttachFile(file2, mimeMessageHelper, fileName);
                String file3 = rootPath + "/attachFile" + "/22_sign_gangwon.jpg";
                fileName = "찾아가는_현장방문_지문등_사전등록제_안내문.jpg";
                addAttachFile(file3, mimeMessageHelper, fileName);
                break;
            default:
                break;
        }
