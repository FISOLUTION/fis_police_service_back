...
public class MailServiceImpl implements MailService {
    ...
    public MailSendResponse sendMail(Long center_id) throws MessagingException {
        try {
            ...
            createMessage(to, mailSender, message);

            validateMailAddr(to);
            sendMail(mailSender, message, response, recentCall);
            return response;
    ...
    private MimeMessageHelper createMessage(String toAddr, JavaMailSender mailSender, MimeMessage message) throws MessagingException {
...
//        String file1 = "/Users/junyeong/study/spring/fis_p`olice_service_back/fis_police_server/src/main/java/fis/police/fis_police_server/attachFile/21년 지문등 사전등록 현장방문 사업추진 관련 협조 요청.pdf";
...
//        mimeMessageHelper.addAttachment("21년 지문등 사전등록 신청서_양식.hwp", fsr3);
    ...
    private void sendMail(JavaMailSender mailSender, MimeMessage message, MailSendResponse response, Call recentCall) {
