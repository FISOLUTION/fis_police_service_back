...
import fis.police.fis_police_server.controller.controllerImpl.ParentControllerImpl;
...
@Slf4j
@RestControllerAdvice(assignableTypes = ParentControllerImpl.class)
public class ParentControllerAdvice {
