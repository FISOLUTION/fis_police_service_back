...
public class ExcelUploadController {
    ...
    public Object r(@ModelAttribute MultipartFile excelFile) throws IOException, NoSuchMethodException {
    ...
    public ExcelCenterDTO readExcel(@RequestBody MultipartFile excelFile) throws IOException, DuplicateSaveException, ParseException {
